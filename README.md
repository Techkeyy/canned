...
The current public marketplace is available at https://canned.103-195-188-198.sslip.io. Its public VPS inspection/API surfaces expose the derived summary projection and provenance references; the exact qualifying TermiX task, agent, and control payloads are publicly available under [evidence/termix](https://github.com/Techkeyy/canned/tree/master/evidence/termix) in the release repository.
